...
CREATE INDEX IF NOT EXISTS evaluations_overall_score_idx ON evaluations (overall_score DESC);
...
CREATE INDEX IF NOT EXISTS training_pairs_quality_idx ON training_pairs (quality_score DESC);
CREATE INDEX IF NOT EXISTS training_pairs_job_idx ON training_pairs (included_in_job);
